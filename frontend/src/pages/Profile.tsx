    ...
    return (
      ...
      `}</style>
            ...
            <div className="pf">
                ...
                {/* PAGE HEADER */}
                <div>
                    <div className="pf-head-eyebrow"><span className="pf-head-dot" />CrediNova Management Cloud</div>
                            ...
                            <form onSubmit={handleSave}>
                                ...
                                <div className="pf-form-footer">
                                    <div className="pf-footer-note">
                                        <Shield size={14} />
                                        Identity verified via CrediNova Governance Protocol.
                                    </div>
                                    <button
                                        type="submit"
                                        disabled={loading}
