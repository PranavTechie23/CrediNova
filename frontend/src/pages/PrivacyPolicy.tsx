...
const sections = [
    {
        ...
        content: (
            <p>
                At <strong>CrediNova</strong>, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform. Please read this policy carefully. If you do not agree with its terms, please do not access the application.
            </p>
        )
    },
    {
    ...
    },
    {
        ...
        content: (
            <div className="pp-list">
                {[
                    "Create and manage your account on the CrediNova platform.",
    ...
    },
    {
        ...
        content: (
            <p>
                ...
                <a href="mailto:support@credinova.ai" className="pp-link">support@credinova.ai</a>.
                ...
                <div className="pp-hero">
                    ...
                    <div className="pp-hero-inner">
                        ...
                        <div className="pp-hero-text">
                            <div className="pp-hero-eyebrow">Data Governance · CrediNova Platform</div>
